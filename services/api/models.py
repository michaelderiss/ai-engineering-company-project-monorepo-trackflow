...
class SupplierCreate(BaseModel):
    ...
    @root_validator
    def validate_currency_by_country(cls, values: dict) -> dict:
        country = values.get("country")
        currency = values.get("currency")
        if country == Country.USA and currency != Currency.USD:
            raise ValueError("Suppliers from USA must use USD.")
        if country == Country.SPAIN and currency != Currency.EUR:
            raise ValueError("Suppliers from Spain must use EUR.")
        return values
